...
public class Weather extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		run = new Runnable() {
			...
			public void run() {
				refreshing(false);
				Toast.makeText(Weather.this, "网络超时,请稍候再试", Toast.LENGTH_SHORT).show();
			}
		};
		...
		public void onClick(View v) {
			...
			if (id == R.id.change_city_layout) {
				...
				intent.putExtra(Intent.EXTRA_TEXT,
						"我正在使用i畅享之游，可以随时随地查看攻略、景点、天气信息，是您出差、旅行的贴心助手！推荐你也试试~");
...
//			super.onBackPressed();
//		} else {
//			Toast.makeText(this, "再按一次继续浏览", Toast.LENGTH_SHORT).show();
//		}
