...
public class UpdateWeather extends WebPage {
	...
	public void onStart() {
		...
		// 申请的百度API KEY，申请地址http://lbsyun.baidu.com/apiconsole/key
		final String ak = "29OYBzIGGssplFiz3zLmwnyP";
	...
	private void analyze(Document doc) {
		...
		if ("success".equals(status)) {
			...
			Element weatherDataElem = doc.getElementsByTag("weather_data").get(0);
